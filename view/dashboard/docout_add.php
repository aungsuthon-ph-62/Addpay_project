                ...
                <div class="p-2 py-md-4 px-md-5 border rounded-3">
                    <form action="" method="post" class="">
                        <div class="row g-3 align-items-center mb-3">
                            <div class="col-md-3">
                                <label for="inputname" class="col-form-label">เลขที่</label>
                            </div>
                            <div class="col-auto">
                                <input type="text" id="input_no" class="form-control " required>
                            </div>
                        </div>
                        <div class="row g-3 align-items-center mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-auto">
                                <input type="date" id="input_date" class="form-control " required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="input_title" class="form-control " required>
                            </div>
                        </div>
                        <div class="row g-3 align-items-center mb-3">
                            <div class="col-md-3 ">
                        ...
                        <div class="row g-3  mb-3">
                            <div class="col-md-3">
                                <label for="inputSend" class="col-form-label">เนื้อหาข้อความ </label>
                            </div>
                            <div class="col-md-9">
                                <textarea id="editor" name="" class="form-control" cols="40" rows="10"
                        ...
                        <div class="row g-3 align-items-center mt-3">
                            <div class="col-md-3 ">
                                <label for="inputSend" class="col-form-label">ชื่อกำกับลายเซ็น</label>
                            </div>
                            <div class="col-md-6">
                                <input type="text" id="inputSend" class="form-control " required>
                            </div>
                        ...
                        <div class="row g-3 align-items-center mt-1 mb-3">
                            <div class="col-md-3 ">
                                <label for="inputSend" class="col-form-label">ตำแหน่งกำกับลายเซ็น</label>
                            </div>
                            <div class="col-md-6">
                                <input type="text" id="inputSend" class="form-control " required>
                            </div>
