...
<body>
    ...
    <div class="container-fluid">
        ...
        <form method="post" id="invtax_form" action="invoicetax_edit.php" class="px-md-5 py-md-5">
            ...
            <div class="mx-auto d-flex justify-content-end">
                ...
                <button type="submit" name="action" value="edit_invoicetax" class="ms-3 col-md-3 btn btn-outline-success p-2 mt-2 rounded-pill fs-5 fw-bold">บันทึก
