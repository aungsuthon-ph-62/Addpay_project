    ...
    <div class="main-body py-md-5 px-md-1 text-white">
        <div id="papinvoicetaxtation" class="container p-3 p-md-5">
            <div class="p-4 p-md-5 bg-white rounded-5 shadow-lg">
                ...
                <form method="post" id="invtax_form"
                    action="?page=invoicetax_edit&editinvtax=<?php echo encode($row['invtax_id'], secret_key()); ?>"
                    class="mt-md-5">
                    ...
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        ...
                        <div class="col-auto">
                            <input type="date" id="input_invtax_date" name="input_invtax_date" class="form-control "
                                required value="<?= $row['invtax_date'] ?>">
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3 text-md-end">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="input_invtax_name" name="input_invtax_name" class="form-control "
                                required value="<?= $row['invtax_name'] ?>">
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3 text-md-end ">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" id="input_invtax_address" name="input_invtax_address"
                                rows="3" required><?= $row['invtax_address']; ?></textarea>
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3 text-md-end ">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" name="action" value="edit_invoicetax"
                                    class="btn btn-addpay text-white">บันทึก<i
                                        class="fa-solid fa-angles-right"></i></button>
                            </div>
                        </div>
                        <input type="hidden" name="total_item" id="total_item" value="<?= $n; ?>" />
                        <input type="hidden" name="invtax_no_check" id="invtax_no_check"
                            value="<?= $row['invtax_no']; ?>" />
                        <input type="hidden" name="invtax_id" id="invtax_id" value="<?= $row['invtax_id']; ?>" />
                        <input type="hidden" name="invtax_date_create" id="invtax_date_create"
                            value="<?= $row['invtax_create']; ?>" />
                    </div>
