    ...
    <div class="main-body py-md-5 px-md-1 text-white">
        <div id="papinvoicetaxtation" class="container p-3 p-md-5">
            <div class="p-4 p-md-5 bg-white rounded-5 shadow-lg">
                ...
                <form method="post" id="invtax_form" action="?page=invoicetax_edit" class="mt-md-5">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" name="action" value="edit_invoicetax" class="btn btn-addpay text-white">บันทึก<i class="fa-solid fa-angles-right"></i></button>
                            </div>
                        </div>
