...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">เพิ่มข้อมูลเอกสารสำคัญ</li>
    </ol>
</nav>
<hr>
    ...
    <div class="main-body py-md-5 px-md-1 text-white">
        <div id="paperquotation" class="container p-3 p-md-5">
            <div class="p-4 p-md-5 bg-white rounded-5 shadow-lg">
                ...
                <form action="?page=archives_add" method="post" class="" enctype="multipart/form-data">
