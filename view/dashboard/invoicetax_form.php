...
$sql = "SELECT * FROM `invoicetax` WHERE quoout_id = '$id'";
...
$sql = "SELECT * FROM `invoicetax_details` WHERE quooutde_quooutid = '$id';";
...
$head2 = ' ';
$sql = "SELECT quoout_total FROM `invoicetax` WHERE quoout_id = '$id'";
$result = mysqli_query($conn, $sql);
$footer = "";
if (mysqli_num_rows($result) > 0) {
    ...
    <div class="container py-md-5 px-md-4" style="width: 100%; ">
        ...
        <div class="mx-auto d-flex justify-content-end ">
            ...
            <a class="btn btn-outline-danger px-2 px-md-4 mt-2 rounded-3 fs-5 fw-bold ms-3" role="button"
                href="./invoicetax_list.php"><i class="fa-regular fa-rectangle-xmark"></i> ยกเลิก</a>
        </div>
        <hr>
        <?php
