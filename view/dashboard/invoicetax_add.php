            ...
            <div class="p-4 p-md-5 bg-white rounded-5 shadow-lg">
                ...
                <form method="post" id="invtax_form" action="?page=invoicetax_add" class="px-md-5 py-md-5">
                    ...
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" id="input_invtax_address" name="input_invtax_address" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3 text-md-end ">
                        ...
                        <div class="col-md-8">
                            <input type="number" id="input_invtax_cusid" name="input_invtax_cusid" class="form-control " pattern="[0-9]{13}" title="กรุณากรอกตัวเลข 0-9 จำนวน 13 หลัก ไม่มี (-)">
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" name="action" value="create_invtax" class="btn btn-addpay text-white">บันทึก<i class="fa-solid fa-angles-right"></i></button>
                            </div>
                        </div>
