        ...
        <nav aria-label="breadcrumb" class="main-breadcrumb mt-2">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a
                        href="../dashboard/invoicetax_list.php">ใบแจ้งหนี้/ใบกำกับภาษี</a></li>
                <li class="breadcrumb-item active" aria-current="page">สร้างใบแจ้งหนี้/ใบกำกับภาษี</li>
            </ol>
        </nav>
        <hr>
        <div>
            <h3>ข้อมูลใบแจ้งหนี้/ใบกำกับภาษี </h3>
        </div>
        <form method="post" id="invtax_form" action="invoicetax_add.php" class="px-md-5 py-md-5">
            <div class="row g-3 align-items-center mb-3">
                <div class="col-md-3">
                    <label for="input_invtax_no" class="col-form-label">เลขที่ No.</label>
                </div>
                <div class="col-auto">
                    <input type="text" id="input_invtax_no" name="input_invtax_no" class="form-control " required>
                </div>
            </div>
            <div class="row g-3 align-items-center mb-3">
                <div class="col-md-3">
                ...
                <div class="col-auto">
                    <input type="date" id="input_invtax_date" name="input_invtax_date" class="form-control " required>
                </div>
            </div>
            <div class="row g-3 align-items-center mb-3">
                <div class="col-md-3">
                ...
                <div class="col-md-8">
                    <input type="text" id="input_invtax_name" name="input_invtax_name" class="form-control " required>
                </div>
            </div>
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-8">
                    <textarea class="form-control" id="input_invtax_address" name="input_invtax_address" rows="3"
                        required></textarea>
                </div>
            </div>
            <div class="row g-3 align-items-center mb-3">
            ...
            <div class="row d-flex flex-row-reverse">
                <div class="col-md-6 ">
                    <div class="row g-3 align-items-center mb-3">
                        ...
                        <div class="col-md-5">
                            <input type="number" id="input_invtax_sum" name="input_invtax_sum" class="form-control "
                    ...
                    <div class="row g-3 align-items-center mb-3">
                        ...
                        <div class="col-md-5">
                            <input type="number" id="input_invtax_vat" name="input_invtax_vat" class="form-control "
                                placeholder="0.00" readonly>
                        </div>
                    </div>
                    <div class="row g-3 align-items-center mb-3">
                        ...
                        <div class="col-md-5">
                            <input type="number" id="input_invtax_total" name="input_invtax_total" class="form-control "
                                placeholder="0.00" readonly>
                        </div>
                    </div>
                </div>
