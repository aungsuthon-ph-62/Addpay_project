            ...
            <div class="p-4 p-md-5 bg-white rounded-5 shadow-lg">
                ...
                <form method="post" id="invtax_form" action="?page=invoicetax_add" class="px-md-5 py-md-5">
                    ...
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="input_invtax_cusid" name="input_invtax_cusid" class="form-control " pattern="[0-9]{13}" title="กรุณากรอกตัวเลข 0-9 จำนวน 13 หลัก ไม่มี (-) " required>
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3">
