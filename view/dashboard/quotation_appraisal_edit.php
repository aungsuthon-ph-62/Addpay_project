    ...
    <div class="container-fluid">
        ...
        <form method="post" id="quotation_form" action="quotation_appraisal_edit.php" class="px-md-5 py-md-5">
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-auto">
                    <input type="number" id="input_quo_no" name="input_quo_no" class="form-control " required value="<?= $row['quo_no'] ?>">
                </div>
            </div>
            <div class="row g-3 align-items-center mb-3">
                <div class="col-md-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row g-3 align-items-center mb-3">
                        ...
                        <div class="col-md-5">
                            <input type="number" step="any" id="input_quo_specialdis" name="input_quo_specialdis" class="form-control " placeholder="0.00" title="กรุณากรอกส่วนลด หากมี" value="<?= $row['quo_specialdis'] ?>">
                        </div>
                    </div>
                    <div class="row g-3 align-items-center mb-3">
                        <div class="col-md-6 ">
            ...
            <div class="mx-auto d-flex justify-content-end">
                ...
                <button type="submit" name="action" value="edit_quotation" class="ms-3 col-md-3 btn btn-outline-success p-2 mt-2 rounded-pill fs-5 fw-bold">บันทึกการแก้ไข
