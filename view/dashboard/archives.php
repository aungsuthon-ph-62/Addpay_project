    ...
    <div class="main-body">
        ...
        <div id="listquotation" class="container pb-md-0 mb-5">
            ...
            <div class="mx-auto d-flex justify-content-end">
                <a class="btn btn-success px-2 px-md-4 mt-2 rounded-3 fs-5 fw-bold " role="button" href="../dashboard/archives_add.php"><i class="fa-solid fa-file-circle-plus"></i> เพิ่มข้อมูล</a>
            </div>
                                    ...
                                    <div>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="../dashboard/archives_edit.php">แก้ไข</a></li>
