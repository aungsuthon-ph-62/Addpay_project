            ...
            <form method="post" action="php/action.php">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4">
                                <div class="form-floating mb-4">
                                    <input type="text"
                                        class="form-control border border-start-0 border-top-0 border-end-0 rounded-0"
                                        id="inputFname" name="inputFname" placeholder="กรอกชื่อจริง"
                                        value="<?= $user['fname'] ?>">
                            ...
                            <div class="col-4">
                                <div class="form-floating mb-4">
                                    <input type="text"
                                        class="form-control border border-start-0 border-top-0 border-end-0 rounded-0"
                                        id="inputLname" name="inputLname" placeholder="กรอกนามสกุล"
                                        value="<?= $user['lname'] ?>">
                        ...
                        <div class="row align-items-center">
                            <div class="col-3 col-md-4">
                                <div class="form-floating mb-4">
                                    <input type="number"
                                        class="form-control border border-start-0 border-top-0 border-end-0 rounded-0"
                                        id="inputAge" name="inputAge" placeholder="กรอกเบอร์โทร" pattern="[1-9]{3}"
                                        value="<?= $user['age'] ?>">
                            ...
                            <div class="col-9 col-md-8 text-md-center mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="btn-check" name="inputGender" id="male-outlined"
                                        value="ชาย"
                                        <?php if ($user['gender'] == 'ชาย') {
                                                                                                                                echo "checked";
                                                                                                                            } ?>>
                                    <label class="btn btn-outline-info rounded-pill" for="male-outlined">ชาย</label>
                                    <input type="radio" class="btn-check" name="inputGender" id="female-outlined"
                                        value="หญิง"
                                        <?php if ($user['gender'] == 'หญิง') {
                                                                                                                                    echo "checked";
                                                                                                                                } ?>>
                                    <label class="btn btn-outline-warning rounded-pill"
                                        for="female-outlined">หญิง</label>
                                    <input type="radio" class="btn-check" name="inputGender" id="other-outlined"
                                        value="อื่นๆ"
                                        <?php if ($user['gender'] == 'อื่นๆ') {
                                                                                                                                    echo "checked";
                                                                                                                                } ?>>
                        ...
                        <div class="row align-items-center">
                            <div class="col-5">
                                ...
                                <div class="form-floating mb-4">
                                    <input type="tel"
                                        class="form-control border border-start-0 border-top-0 border-end-0 rounded-0"
                                        id="inputPhone" name="inputPhone" placeholder="กรอกเบอร์โทร"
                                        value="<?= $user['phone'] ?>">
                            ...
                            <div class="col-7">
                                ...
                                <div class="form-floating mb-4">
                                    <input type="email"
                                        class="form-control border border-start-0 border-top-0 border-end-0 rounded-0"
                                        id="inputEmail" name="inputEmail" placeholder="กรอกอีเมลล์"
                                        value="<?= $user['email'] ?>">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <div class="form-floating mb-4">
                                    <input type="text"
                                        class="form-control border border-start-0 border-top-0 border-end-0 rounded-0"
                                        id="inputPosition" name="inputPosition" placeholder="กรอกตำแหน่ง"
                                        value="<?= $user['position'] ?>">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-4">
                                    <input type="text"
                                        class="form-control border border-start-0 border-top-0 border-end-0 rounded-0"
                                        id="inputDepartment" name="inputDepartment" placeholder="กรอกแผนก"
                ...
                <div class="px-3">
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark bg-secondary-addpay border-0"
            ...
            <form method="post" action="php/action.php">
                <div class="modal-body">
                    ...
                    <div class="p-3 p-md-5">
                        <div class="form-floating mb-4">
                            <input type="text"
                                class="form-control form-control-lg border border-start-0 border-top-0 border-end-0 rounded-0"
                                id="inputUsername" name="inputUsername" placeholder="ชื่อผู้ใช้ปัจจุบัน">
                            <label for="inputUsername" class="form-label">ชื่อผู้ใช้ปัจจุบัน</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text"
                                class="form-control form-control-lg border border-start-0 border-top-0 border-end-0 rounded-0"
                                id="inputNewUsername" name="inputNewUsername" placeholder="ชื่อผู้ใช้ใหม่">
                            <label for="inputNewUsername" class="form-label">ชื่อผู้ใช้ใหม่</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text"
                                class="form-control form-control-lg border border-start-0 border-top-0 border-end-0 rounded-0"
                                id="confirmNewUsername" name="confirmNewUsername" placeholder="ยืนยันชื่อผู้ใช้ใหม่">
...
<!-- Change Password -->
<div class="modal fade" id="profileeditpassModal" tabindex="-1" aria-labelledby="profileeditpassModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="p-3 p-md-5">
                        <div class="form-floating mb-4">
                            <input type="password"
                                class="form-control form-control-lg border border-start-0 border-top-0 border-end-0 rounded-0"
                                id="inputPassword" name="inputPassword" placeholder="รหัสผ่านปัจจุบัน">
                            <label for="inputPassword" class="form-label">รหัสผ่านปัจจุบัน</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="password"
                                class="form-control form-control-lg border border-start-0 border-top-0 border-end-0 rounded-0"
                                id="inputNewPassword" name="inputNewPassword" placeholder="รหัสผ่านใหม่">
                            <label for="inputNewPassword" class="form-label">ชื่อผู้ใช้ใหม่</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="password"
                                class="form-control form-control-lg border border-start-0 border-top-0 border-end-0 rounded-0"
                                id="confirmNewPassword" name="confirmNewPassword" placeholder="ยืนยันรหัสผ่านใหม่">
            ...
            <form method="post" action="php/action.php" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="px-4 text-center">
                        <input class="form-control" id="profile" name="image" type="file" accept="image/*"
