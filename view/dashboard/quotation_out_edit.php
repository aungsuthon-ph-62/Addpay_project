...
function edit_quoout()
{
    ...
    if ($conn->query($query1) === TRUE && $conn->query($query2) === TRUE) {
        ...
        for ($count = 0; $count < $_POST["total_item"]; $count++) {
            ...
            $query = "INSERT INTO quotation_out_details (quooutde_quoid, quooutde_item, quooutde_amount, quooutde_price, quooutde_result, quooutde_create, quooutde_update, quooutde_uid)
    ...
    <div class="container-fluid">
        ...
        <form method="post" id="quoout_form" action="quotation_out_edit.php" class="px-md-5 py-md-5">
            ...
            <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-md-8">
                    <input type="number" id="input_quoout_numtax" name="input_quoout_numtax" class="form-control " pattern="[0-9]{13}" value="<?= $row['quoout_numtax'] ?>">
                </div>
            </div>
            <div class="row g-3 align-items-center mb-3">
                <div class="col-md-3 ">
            ...
            <div class="mx-auto d-flex justify-content-end">
                ...
                <button type="submit" name="action" value="edit_quotation_out" class="ms-3 col-md-3 btn btn-outline-success p-2 mt-2 rounded-pill fs-5 fw-bold">บันทึกการแก้ไข
