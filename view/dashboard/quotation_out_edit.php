...
function edit_quoout()
{
    ...
    if ($conn->query($query1) === TRUE && $conn->query($query2) === TRUE) {
        ...
        for ($count = 0; $count < $_POST["total_item"]; $count++) {
            ...
            $query = "INSERT INTO quotation_out_details (quooutde_quooutid, quooutde_item, quooutde_amount, quooutde_price, quooutde_result, quooutde_create, quooutde_update)
                VALUES ('$id', '$item_name', '$item_amount', '$item_price', '$total_price', '$quoout_date_create', '$date')";
            $conn->query($query);
        }

        $_SESSION['success'] = "แก้ไขใบเสนอราคาสำเร็จ!";
        echo "<script> window.location.href='?page=quo_out';</script>";
        exit;
    } else {
    ...
    <div class="main-body py-md-5 px-md-1 text-white">
        <div id="paperquotation" class="container p-3 p-md-5">
            <div class="p-4 p-md-5 bg-white rounded-5 shadow-lg">
                ...
                <form method="post" id="quoout_form"
                    action="?page=quo_out_edit&editquo=<?php echo encode($row['quoout_id'], secret_key()); ?>"
                    class="mt-md-5">
                    ...
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        ...
                        <div class="col-auto">
                            <input type="date" id="input_quoout_date" name="input_quoout_date" class="form-control "
                                required value="<?= $row['quoout_date'] ?>">
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3 text-md-end">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="input_quoout_name" name="input_quoout_name" class="form-control "
                                required value="<?= $row['quoout_name'] ?>">
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3 text-md-end">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" id="input_quoout_address" name="input_quoout_address"
                                rows="3" required><?= $row['quoout_address']; ?></textarea>
                        </div>
                    </div>
                    <div class="row align-items-center text-dark px-md-5 mb-3">
                        <div class="col-md-3 text-md-end">
                                    ...
                                    <tr id="row_id_<?= $n; ?>">
                                        ...
                                        <td>
                                            <input type="text" name="item_name[]" id="item_name<?= $n; ?>"
                                                ...
                                                value="<?= $rows["quooutde_item"]; ?>" required />
                                        </td>
                                        <td>
                            ...
                            <div class="row align-items-center text-dark px-md-5 mb-3">
                                ...
                                <div class="col-md-6">
                                    <input type="number" step="any" id="input_quoout_specialdis"
                                        ...
                                        title="กรุณากรอกส่วนลด หากมี" value="<?= $row['quoout_specialdis'] ?>">
                                </div>
                            </div>
                            <div class="row align-items-center text-dark px-md-5 mb-3">
                                <div class="col-md-6 text-md-end">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-end">
                                ...
                                <input type="hidden" name="quoout_no_check" id="quoout_no_check"
                                    value="<?= $row['quoout_no']; ?>" />
                                <input type="hidden" name="quoout_id" id="quoout_id"
                                    value="<?= $row['quoout_id']; ?>" />
