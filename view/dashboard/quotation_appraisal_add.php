...
function create_quotation(){
    ...
    $input_quo_numtax= mysqli_real_escape_string($conn,trim($_POST['input_quo_numtax']));
    ...
    if ($check) {
        ...
        $query = "INSERT INTO quotation_appraisal (quo_no, quo_date, quo_name, quo_address, quo_numtax, quo_remark, quo_sum, quo_specialdis, quo_afterdis, quo_vat, quo_total, quo_texttotal, quo_create, quo_uid)
            VALUES ('$input_quo_no', '$input_quo_date', '$input_quo_name', '$input_quo_address', '$input_quo_numtax', '$input_quo_remark', '$input_quo_sum', '$input_quo_specialdis', '$input_quo_afterdis', '$input_quo_vat', '$input_quo_total', '$input_quo_texttotal', '$input_quo_create', '$input_quo_uid')";
...
<body>
    ...
    <div class="container-fluid">
        ...
        <form method="post" id="quotation_form" class="px-md-5 py-md-5">
            ...
            <div class="row g-3 align-items-center mb-3">
                <div class="col-md-3">
                    <label for="input_quo_name" class="col-form-label">ชื่อลูกค้า :</label>
                </div>
                <div class="col-md-8">
            ...
            <div class="row g-3 align-items-center mb-3">
                <div class="col-md-3 ">
                    <label for="input_quo_numtax" class="col-form-label">เลขประจำตัวผู้เสียภาษี :</label>
                </div>

                <div class="col-md-8">
                    <input type="text" id="input_quo_numtax" name="input_quo_numtax" class="form-control "
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row g-3 align-items-center mb-3">
                        <div class="col-md-6 ">
                            <label for="input_quo_afterdis" class="col-form-label">ยอดรวมหลังหักส่วนลด(บาท) :</label>
                        </div>
            ...
            <div class="row g-3  mb-3">
                <div class="col-md-3">
                    <label for="input_quo_texttotal" class="col-form-label">จำนวนเงินตัวอักษร : <br> The Sum Of Bahts
                    </label>
                </div>
                <div class="col-md-9">
