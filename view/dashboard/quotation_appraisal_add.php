...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="?page=quotation">ใบเสนอราคา</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row g-3 align-items-center mb-3">
                        ...
                        <div class="col-md-5">
                            <input type="number" step="any" id="input_quo_specialdis" name="input_quo_specialdis" class="form-control " placeholder="0.00" title="กรุณากรอกส่วนลด หากมี">
                        </div>
                    </div>
                    <div class="row g-3 align-items-center mb-3">
                        <div class="col-md-6 ">
