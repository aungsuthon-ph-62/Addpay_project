    ...
    <div class="main-body p-md-5 text-white">
        <div id="quo_add" class="container p-3 p-md-5">
            <div class="p-4 p-md-5 bg-white rounded-5 shadow-lg">
                ...
                <form method="post" id="quotation_form" action="?page=quo_add" class="px-md-5 py-md-5">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" id="action" name="action" value="create_quotation"
                                    class="btn btn-addpay text-white create_docout">บันทึก
