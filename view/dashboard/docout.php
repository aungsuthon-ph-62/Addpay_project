...
<div class="container py-5">
    ...
    <div class="d-flex flex-row-reverse mb-3">
         <a class="btn btn-primary" role="button" href="../dashboard/docout_add.php">เพิ่มข้อมูล <i class="fa-solid fa-plus"></i></a>
                ...
                <table class="table table-striped caption-top" id="showTimeTable">
                    ...
                    <tbody class="text-center">
                        <tr>
                            ...
                            <td>
                                <!-- <?php echo $rows['docout_srcname']; ?> -->
                            </td>
                            <td>
                                <!-- <?php echo $rows['docout_date']; ?> -->
                            </td>
                            <td>
                                <!-- <?php echo $rows['docout_title']; ?> -->
                            </td>
                            <td>
                                <!-- <?php echo $rows['docout_to']; ?> -->
                            </td>
                            <td>
                                <!-- <?php echo $rows['docout_file']; ?> -->
                            </td>
                            <td><a href="../dashboard/docout_edit.php" class="data-bs-toggle='modal' data-bs-target='#editReportModal'">
