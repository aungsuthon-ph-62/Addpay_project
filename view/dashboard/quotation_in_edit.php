    ...
    <div class="main-body py-md-5 px-md-1 text-white">
        <div id="paperquotation" class="container p-3 p-md-5">
            <div class="p-4 p-md-5 bg-white rounded-5 shadow-lg">
                ...
                <form method="post"
                    action="?page=quo_in_edit&editquoin=<?php echo encode($row['quoin_id'], secret_key()); ?>"
                    enctype="multipart/form-data" class="mt-md-5">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="input_quoin_status"
                                    ...
                                    <?php if ($row['quoin_status'] == 'ไม่อนุมัติ') : ?> checked='checked'
                                    <?php endif; ?>>
