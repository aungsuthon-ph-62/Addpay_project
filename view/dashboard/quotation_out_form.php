...
$a = file_get_contents('./quotation_out_PDF/quotation_out_content.php');
$stylesheet = file_get_contents('./quotation_PDF/quotation_PDF.css');
$mpdf->WriteHTML($stylesheet, \Mpdf\HTMLParserMode::HEADER_CSS);
$mpdf->WriteHTML($a, \Mpdf\HTMLParserMode::HTML_BODY);
$mpdf->Output('./quotation_out_PDF/quotation_out.pdf'); //link web of file pdf
...
<body>
    ...
    <div class="container py-md-5 px-md-4" style="width: 100%; ">
        ...
        <div class="mx-auto d-flex justify-content-end ">
            <a class="btn btn-outline-success px-2 px-md-4 mt-2 rounded-3 fs-5 fw-bold" role="button" href="./quotation_out_PDF/quotation_out.pdf"><i class="fa-solid fa-print"></i> พิมพ์เอกสาร</a>
