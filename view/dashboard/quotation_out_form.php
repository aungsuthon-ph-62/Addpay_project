...
<body>
    ...
    <div class="container py-md-5 px-md-4" style="width: 100%; ">
        ...
        <div class="mx-auto d-flex justify-content-end me-5">
            <a class="btn btn-addpay px-2 px-md-4 mt-2 rounded-3 fs-5 fw-bold text-light" role="button" href="./quotation_out_PDF/quotation_out0.pdf"><i class="fa-solid fa-print"></i> พิมพ์เอกสาร</a>
        </div>
        <hr>
        <?php
