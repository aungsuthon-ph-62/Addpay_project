  ...
  <div class="container py-5 py-sm-4 py-md-5">
    <div class="row d-flex align-items-center justify-content-center h-100 bg-white rounded-5 px-md-5 py-md-4">
      ...
      <div class="col-12 col-md-6 px-4 py-4 py-md-0">
        ...
        <form class="container mt-md-2 mt-lg-2" action="" method="">
          <!-- name input -->
          <div class="row">
            <div class="form-floating col-12 mb-3 mb-md-4 ">
              <input type="text" class="form-control border border-start-0 border-top-0 border-end-0 rounded-0" id="inputUsername" name="inputUsername" placeholder="กรอกชื่อผู้ใช้">
              <label class="ms-2" for="inputUsername"><i class="fa-solid fa-user"></i> ชื่อผู้ใช้</label>
            </div>
            <!-- Password input -->
            <div class="form-floating col-12 mb-3 mb-md-4">
              <input type="password" class="form-control border border-start-0 border-top-0 border-end-0 rounded-0" id="inputPassword" name="inputPassword" placeholder="กรอกพาสเวิร์ด">
          ...
          <div class="form-row mb-2">
            <div class="d-grid gap-2 col-12 mx-auto mb-4">
              <button type="submit" name="submit" class="btn p-3 mt-3 text-white" style="background-color:#FE9100 ;">เข้าสู่ระบบ <i class="fa-solid fa-right-to-bracket"></i></button>
            </div>
          </div>
